...
extension OnTheMapClient {
    func authenticateWithVC(_ hostViewController: UIViewController, _ userName: String, _ password: String, completionHandlerForAuth: @escaping (_ sucess: Bool, _ errorString: String?) -> Void) {
    ...
    func logoutWithVC(_ hostViewController: UIViewController, completionHandlerForLogout: @escaping (_ success: Bool, _ errorString: String?) -> Void) {
